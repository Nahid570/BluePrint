...
export const getTransactions = async (params?: {
  ...
  try {
    const response = await httpClient.get<TransactionsListResponse>(
...
export const getTransactionDetail = async (
  ...
  try {
    const response = await httpClient.get<TransactionDetailResponse>(
    ...
    if (error.response) {
      ...
      if (typeof errorData === "object" && errorData !== null) {
        throw {
          success: false,
          code: errorData.code || error.response.status,
          message: errorData.message || "Failed to fetch transaction details",
          errors: errorData.errors,
        };
      }
      throw {
